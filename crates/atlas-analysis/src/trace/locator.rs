...
use atlas_types::structs::{Callsite, ReferenceUse, TextRange};
use atlas_types::trace::{TraceDataNodeRef, TracePoint};
...
where
    F: Fn(&atlas_types::dataflow::DataFlowEdge) -> &DataNodeId,
{

...
impl NameMatcher {
    ...
    pub fn name_similarity(&self, a: &str, b: &str) -> Confidence {
        ...
        let dist = atlas_types::levenshtein(a, b);
...
mod tests {
    ...
    fn test_levenshtein_distance() {
        assert_eq!(atlas_types::levenshtein("kitten", "sitting"), 3);
        assert_eq!(atlas_types::levenshtein("foo", "foo"), 0);
        assert_eq!(atlas_types::levenshtein("foo", "bar"), 3);
        assert_eq!(atlas_types::levenshtein("", "abc"), 3);
    }
}

...
use crate::bindings::{BindingDef, BindingUse};
use crate::cfg::{CfgEdge, CfgNode};
use crate::dataflow::{DataFlowEdge, DataNode};
use crate::enums::*;
use crate::ids::*;
...
pub struct ReferenceUse {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub binding_id: Option<crate::ids::BindingId>,

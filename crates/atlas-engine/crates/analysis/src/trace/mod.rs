...
//!    [`types::trace::TracePoint`] containing the reference, symbol,
...
//!    [`types::trace::TracePath`] from origin to target.
//! 3. **CallerPathExplorer** — walks backward through call edges (`Calls`,
//!    `Instantiates`, `Implements`) to produce a
//!    [`types::caller_path::CallerChain`] from an entry-point to a
//!    target function.
//!

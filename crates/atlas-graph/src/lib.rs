...
impl GraphEngine {
    ...
    pub fn importers(&self, file_id: &atlas_types::ids::FileId) -> Vec<SymbolId> {
    ...
    pub fn file_symbols(&self, file_id: &atlas_types::ids::FileId) -> Vec<SymbolId> {
        self.snapshot
...
mod tests {
    ...
    use atlas_types::{Confidence, Language, Provenance, SymbolKind, Visibility};
    ...
    fn make_edge(source: SymbolId, target: SymbolId, kind: EdgeKind) -> atlas_types::RawEdge {
        use atlas_types::ids::EdgeId;

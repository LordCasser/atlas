...
仅当版本字符串为 `2026-07-28` 或更新的日期版本时添加缓存字段。`None`、`2025-11-25` 及更旧版本均省略字段。日期版本比较沿用 rmcp 对 ISO `YYYY-MM-DD` 协议版本的有序比较方式。rmcp 3.0.1 当前只协商已支持的版本；更新日期版本测试仅锁定未来版本获支持并成功协商后的 adapter policy。

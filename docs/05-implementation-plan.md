...
| M5 | Search & Context | FTS/hybrid search/context/explore |
| M6 | MCP MVP | MCP tools 可供 Agent 使用 |
| M7 | Incremental Sync | 增量同步和 snapshot refresh |
| M8 | Dataflow-lite Foundation | callsite/argument/return/assignment 基础 |

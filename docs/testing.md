...
- 所有已编译语言至少进入一条 Focus function-unit 与 full Index 的 bindings、dataflow（含 edge kind/confidence）、CFG
  ...
  destructuring、JS/TS/ArkTS、C/C++/Java/C# 与 PHP direct-variable mutation、Ruby multiple assignment、Java guarded type/record pattern、C# parenthesized nested designation、Kotlin

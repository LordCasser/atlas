...
- ✅ TypeScript、JavaScript、ArkTS、Java、C、C++ 的普通 block/sibling-block
  ...
  overlapping local shadowing；pattern variable 仍保持保守。

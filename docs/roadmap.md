...
- ✅ TypeScript、JavaScript、ArkTS、Java、C、C++、Go、Rust、Kotlin、Cangjie 的普通 block/sibling-block，以及 PHP assignment/anonymous-function
  ...
  arrow-function ownership 暂不伪造；各语言的 pattern、mixed declaration、smart-cast 与

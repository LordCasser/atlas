...
runtime-length suffix projection、borrow/move mode 与 condition/guard control dependency
仍保守；Kotlin 已覆盖 parameter/local/catch 的 scope-chain binding、

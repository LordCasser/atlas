...
Full Index 与 Focus LazyDataflow 不需要第二套语义。
...
Index Full 与 Focus LazyDataflow 因此共享同一 extraction 结果，不在消费层重建激活或投影规则。

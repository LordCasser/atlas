...
use crate::db::Store;
use crate::types::dataflow::DataFlowEdge;
    ...
    fn virtual_incoming(
        ...
        match target_node.kind {
            ...
            DataNodeKind::CallReturn | DataNodeKind::Expr => {
                ...
                if let Ok(summary) =
                    crate::analysis::summary::SummaryBuilder::build(
                        store,
                        &callee_sym_id,
...
impl TraceEdge {
    ...
    pub fn to_dataflow_edge(&self) -> DataFlowEdge {
        DataFlowEdge {
            id: crate::types::ids::DataFlowEdgeId::generate(
                &self.source_id,
                &self.target_id,
                self.kind.as_str(),
            ),
            ...
            location: crate::types::structs::TextRange {
                start_byte: 0,
                end_byte: 0,
                start_line: 0,
                start_column: 0,

...
//! All four traits are implemented on [`Store`](super::Store) and delegate
...
pub trait CallGraphReader {
    ...
    fn find_callsite_by_reference_id(&self, reference_id: &ReferenceId) -> Result<Option<Callsite>>;

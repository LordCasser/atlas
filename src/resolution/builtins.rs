...
const JAVA_BUILTINS: &[&str] = &[
    ...
    "Iterable", "Iterator", "Collection", "List", "Set", "Map",
    "ArrayList", "LinkedList", "HashMap", "HashSet", "TreeMap", "TreeSet",
    "LinkedHashMap", "LinkedHashSet", "Hashtable", "Vector", "Stack",
    "Collections", "Arrays", "Objects", "Optional", "OptionalInt",
    "Comparator", "Comparable", "AutoCloseable",
    "Override", "Deprecated", "SuppressWarnings", "FunctionalInterface",
    "StackTraceElement", "Enum", "Record",
    // java.io common
    "File", "InputStream", "OutputStream", "Reader", "Writer",
    "PrintStream", "PrintWriter", "BufferedReader", "BufferedWriter",
    "Serializable", "Closeable", "Flushable",
    // java.net common
    "URL", "URI", "Socket", "ServerSocket", "InetAddress",
    // java.util common
    "Date", "Calendar", "Scanner", "Random", "Properties",
    "Base64", "Timer", "TimerTask",
    // java.time common
    "LocalDate", "LocalTime", "LocalDateTime", "Instant",
    "Duration", "Period", "ZoneId", "ZonedDateTime",
...
const C_BUILTINS: &[&str] = &[
    ...
    "fopen", "fclose", "freopen", "fread", "fwrite", "fflush",
    "fgets", "fputs", "puts", "gets", "getchar", "putchar",
    "feof", "ferror", "clearerr", "fseek", "ftell", "rewind",
    "remove", "rename", "tmpfile", "tmpnam",
    "EOF", "FILE", "stdin", "stdout", "stderr",
    "BUFSIZ", "SEEK_SET", "SEEK_CUR", "SEEK_END",
    // stdlib.h
    "malloc", "calloc", "realloc", "free",
    "exit", "abort", "atexit", "quick_exit", "at_quick_exit",
    ...
    "strchr", "strrchr", "strstr", "strlen", "strtok",
    "strdup", "strerror", "strdup",
    ...
    // errno.h
    "errno", "EINVAL", "ENOENT", "ENOMEM", "ERANGE",
    // ctype.h
    "isalpha", "isdigit", "isalnum", "isspace", "isupper", "islower",
    "toupper", "tolower", "isprint", "ispunct", "iscntrl", "isxdigit",
    // signal.h
    "signal", "raise", "SIGINT", "SIGTERM", "SIGKILL", "SIGSEGV",
...
const CPP_BUILTINS: &[&str] = &[
    ...
    "NULL", "printf", "fprintf", "sprintf", "scanf",
    "malloc", "calloc", "realloc", "free",
    "exit", "abort", "atoi", "atol", "atof",
    "memcpy", "memset", "memcmp", "memchr",
    "strcpy", "strncpy", "strcat", "strcmp", "strncmp",
    "strchr", "strstr", "strlen", "strdup", "strerror",
    "size_t", "ptrdiff_t", "intptr_t", "uintptr_t",
    "int8_t", "int16_t", "int32_t", "int64_t",
    "uint8_t", "uint16_t", "uint32_t", "uint64_t",
    "assert", "errno",
    ...
    // iostream
    "cout", "cin", "cerr", "clog",
    "endl", "flush", "ws", "noskipws", "skipws",
    "std",
    // STL containers
    "vector", "string", "wstring", "u16string", "u32string",
    "list", "forward_list", "deque", "queue", "priority_queue", "stack",
    ...
    "transform", "for_each", "remove", "remove_if", "unique",
    "reverse", "rotate", "shuffle", "sample",
    "count", "count_if", "min", "max", "minmax", "clamp",
    "min_element", "max_element", "minmax_element",
    "accumulate", "reduce", "inner_product",
    "binary_search", "lower_bound", "upper_bound", "equal_range",
    "merge", "inplace_merge", "includes",
    "swap", "iter_swap", "exchange",
    "make_heap", "push_heap", "pop_heap", "sort_heap",
    "is_sorted", "is_heap", "nth_element",
    ...
    // Utility
    "move", "forward", "make_pair", "make_tuple", "get",
    "function", "bind", "hash",
    // Thread
    "thread", "mutex", "recursive_mutex", "condition_variable",
    "async", "future", "promise", "packaged_task",
    "scoped_lock", "jthread",
    // Memory
    "allocator", "new", "delete",
    // Type traits
    "is_integral", "is_floating_point", "is_pointer", "is_reference",
    "is_const", "is_array", "is_function", "is_class", "is_enum",
    "is_same", "is_base_of", "is_convertible", "is_constructible",
    "enable_if", "conditional", "decay", "remove_reference", "remove_const",
    "add_pointer", "add_reference", "add_const",

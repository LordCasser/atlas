...
impl CallsiteExtractorSpec for GenericCallsiteExtractor {
    fn extract_callsite(
        ...
        let call_range = crate::extraction::languages::node_range(call_node);
        let callee_range = crate::extraction::languages::node_range(node);
        ...
        let (receiver_range, receiver_text) = if is_method {
            ...
            if let Some(obj) = call_node.child(0) {
                let range = crate::extraction::languages::node_range(obj);
    ...
    for child in call_node.children(&mut cursor) {
        ...
        if kind == "arguments" || kind == "argument_list" || kind == "parenthesized_list" {
            ...
            for arg_child in child.children(&mut arg_cursor) {
                ...
                args.push(crate::extraction::languages::node_range(arg_child));
            }
            break;
        }
    }
...
pub fn create_extractor(lang: crate::types::enums::Language) -> Box<dyn CallsiteExtractorSpec> {
    match lang {
        #[cfg(feature = "typescript")]
        crate::types::enums::Language::TypeScript
        | crate::types::enums::Language::JavaScript
        | crate::types::enums::Language::ArkTS => Box::new(ts_callsite_extractor()),
        #[cfg(feature = "python")]
        crate::types::enums::Language::Python => Box::new(python_callsite_extractor()),
        #[cfg(feature = "java")]
        crate::types::enums::Language::Java => Box::new(java_callsite_extractor()),
        #[cfg(feature = "c")]
        crate::types::enums::Language::C => Box::new(c_callsite_extractor()),
        #[cfg(feature = "cpp")]
        crate::types::enums::Language::Cpp => Box::new(c_callsite_extractor()),
        #[cfg(feature = "cangjie")]
        crate::types::enums::Language::Cangjie => Box::new(cangjie_callsite_extractor()),

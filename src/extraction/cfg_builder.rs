...
struct CfgContext<'a> {
    ...
    edges: Vec<CfgEdge>,
    source: &'a [u8],
    prev_node_id: Option<crate::types::ids::CfgNodeId>,
}
...
impl CfgContext<'_> {
    fn add_node(&mut self, kind: CfgNodeKind, start_byte: u32) -> crate::types::ids::CfgNodeId {
        let range = TextRange {
            start_byte,
            end_byte: start_byte,
            start_line: 0,
    ...
    fn emit_stmt(&mut self, kind: CfgNodeKind, start_byte: u32) -> crate::types::ids::CfgNodeId {
